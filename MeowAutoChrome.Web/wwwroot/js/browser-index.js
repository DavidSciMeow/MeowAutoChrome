// Extracted browser index scripts (partial): handles initialization, SignalR hookup and instance actions.
(function () {
    // All browser UI logic moved from Index.cshtml into this file.
    // Expects window.__browserConfig to be set by the server-side view with values used below.
