...
public sealed class PluginExecutionService
{
    ...
    public Task<PAResult> ExecuteAsync(RuntimeBrowserPluginInstance instance, IHostContext hostContext, Func<IPlugin, Task<PAResult>> execute, CancellationToken cancellationToken)
        => _executor.ExecuteAsync(instance, hostContext, execute, cancellationToken);

    public Task<PAResult> ExecuteActionAsync(RuntimeBrowserPluginInstance instance, RuntimeBrowserPluginAction action, IHostContext hostContext, CancellationToken cancellationToken)
    {
    ...
    public Task<PAResult> ExecuteControlAsync(RuntimeBrowserPluginInstance instance, string command, IHostContext hostContext, CancellationToken cancellationToken)
    {
